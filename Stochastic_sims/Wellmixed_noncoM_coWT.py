...
steady_time=1000 #time to (stochastically) define the steady state
mutant=1 #number of mutants to add after reaching steady state
t_back=30
...
for z in range(repeat_main):
    ...
    np.savetxt('noncoMcoWT_'+str(y_1)+'burst'+str(y_2)+'_'+str(alpha)+'alpha'+str(beta)+'_'+str(lyse_time_1)+'tau'+str(lyse_time_2)+'_'+str(sys.argv[1])+'.txt',result_main,delimiter=' ')
