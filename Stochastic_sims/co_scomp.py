...
steady_time=10000 #time to (stochastically) define the steady state
t_back=300
...
np.savetxt('co_scomp_dt01_'+str(y_1)+'burst'+str(y_2)+'_'+str(alpha)+'alpha'+str(beta)+'_'+str(lyse_time_1)+'tau'+str(lyse_time_2)+'_'+str(sys.argv[1])+'.txt',(s, s_error))
