# Changes made compared to previous version 'Wellmixed_noncoWT_coM.py'
...
for z in range(repeat_main):
    ...
    np.savetxt('noncoWTcoM_ng_'+str(y_1)+'burst'+str(y_2)+'_'+str(alpha)+'alpha'+str(beta)+'_'+str(lyse_time_1)+'tau'+str(lyse_time_2)+'_'+str(sys.argv[1])+'.txt',result_main,delimiter=' ')
    # np.savetxt('noncoWTcoM_neutral_test_'+str(sys.argv[1])+'.txt',result_main,delimiter=' ')
