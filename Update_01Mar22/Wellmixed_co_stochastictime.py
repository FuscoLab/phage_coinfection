...
class Bacteria:
    def __init__(self, location):
        ...
        self.lysis_time = 0 #used to monitor the time initially infected
        self.alive = 1
...
for z in range(repeat_main):
    ...
    np.savetxt('co_st_'+str(y_1)+'burst'+str(y_2)+'_'+str(alpha)+'alpha'+str(beta)+'_'+str(lyse_time_1)+'tau'+str(lyse_time_2)+'_'+str(sys.argv[1])+'.txt',result_main,delimiter=' ')
time_end = time.time()
